        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              margin: EdgeInsets.only(left:21.0, top:10.0),
              //new  Padding(padding: const EdgeInsets.only(left:50.0, top:20.0),),
              child:Text("Welcome to Medibank!",style: new TextStyle(color: Colors.black,
                  fontSize: Responsive.isSmallScreen(context)? width/18 : width/60,
                  fontWeight: FontWeight.w500,fontFamily: 'Poppins'),),
            ),


            Padding(padding: EdgeInsets.only(top: 15.0,right: 30.0, left:30.0)),
            Center(
              child: Container(
                width: width,
            ...
            Transform.translate(
                      ...
                      child: Align(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("Google", style:new TextStyle(color: Colors.black, fontSize:  Responsive.isSmallScreen(context)? width/
                                25:width/60,fontFamily: 'Poppins', fontWeight: FontWeight.w900)),
                          ],
                        ),
                      ),
                    ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Center(child: Text('Already a member?', style: TextStyle(color: Color(0xffACADAC),
                    fontSize: Responsive.isSmallScreen(context)? width/25 : width/60,),)),
                  Center(child: TextButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context)=> Signin(),));
                    },
                    child: Text('Sign in', style: TextStyle(color: Color(0xff191F32),
                        fontSize: Responsive.isSmallScreen(context)? width/25 : width/60),),
                  ),),
                ],
              ),
