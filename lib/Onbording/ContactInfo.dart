...
class ContacInfoState extends State<ContacInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    icon: Image.asset('image/dialog_cancel.png',height:Responsive.isSmallScreen(context) ? width / 24: width / 10,width: Responsive.isSmallScreen(context) ? width / 24 : width / 10 ,),
    onPressed: () {
