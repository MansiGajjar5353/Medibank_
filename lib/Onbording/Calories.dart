              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 20),
                    child: Text(
                      "Lorem ipsum dolor sit amet consectetur. Tellus vel sapien eget fermentum ultricies",
                      style: TextStyle(
                          fontSize: 9,
                          fontWeight: FontWeight.w400,
                            ...
                            Stack(
                              children: [
                                Container(
                                    ...
                                    child: Image(
                                        image:
                                            AssetImage("image/Circle1.png"))),
                                Container(
                                  margin: EdgeInsets.only(top: 26, left: 5),
                                  height: 30,
                                  child: Image(
                                      image: AssetImage("image/Fire3.png")),
                                )
                              ],
                            ),
                            Container(
                            ...
                            Stack(
                              children: [
                                ...
                                Container(
                                  ...
                                  height: 24,
                                  child: Image(
                                      image: AssetImage("image/Vec2.png")),
                                )
                              ],
                            ),
                            Container(
