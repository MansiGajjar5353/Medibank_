    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          Container(
            margin:
                EdgeInsets.only(left: _mediaquery.size.width * 0.09, top: 10),
            child: Text(
              "Please enter the code provided by the doctor",
              style: TextStyle(
          ...
          Container(
            margin: EdgeInsets.only(
                left: _mediaquery.size.width * 0.09,
                right: _mediaquery.size.width * 0.09,
                top: 12),
            width:
                Responsive.isSmallScreen(context) ? width / 0.2 : width / 0.3,
            height: 55,
            child: TextField(
//
          ...
          Container(
            margin:
                EdgeInsets.only(left: _mediaquery.size.width * 0.09, top: 12),
            child: Text(
              "Valid Upto",
              style: TextStyle(
                  color: Color(0xff4F555A).withOpacity(0.45),
...
//
          ...
          Padding(
              padding: EdgeInsets.only(top: _mediaquery.size.height * 0.45)),
          Center(
            child: Container(
