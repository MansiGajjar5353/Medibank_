        ...
        children: [
          ...
          Container(
            ...
            height: Responsive.isSmallScreen(context)
                ? _mediaquery.size.height * 0.88
                : _mediaquery.size.height * 1.5,
                          ...
                          children: [
                            Container(
                              ...
                              width: Responsive.isSmallScreen(context)
                                  ...
                                  : width / 15,
                              child:
                                  Image(image: AssetImage('image/Report1.png')),
                            ),
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                        color:
                                            Color(0xff24B445).withOpacity(0.5),
                                        fontSize:
                                            Responsive.isSmallScreen(context)
                                                ? width / 50
                                                : width / 60,
