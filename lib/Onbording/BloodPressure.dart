  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Blood Pressure", style: TextStyle(color: Color(0xff000000),fontSize: 18, fontWeight: FontWeight.w400, fontFamily: 'Poppins'),),
...
Padding(padding: EdgeInsets.only(top: 20)),
            ...
            child: Column(
              children: [
                ...
                Container(
                  margin: EdgeInsets.only(top: 10),
                  height: 63,
                  width: Responsive.isSmallScreen(context) ? width/2.5: width/4,
                  decoration: BoxDecoration(
          ...
          Container(
            ...
            width: 100,
            height:100,
            child:Image(image: AssetImage('image/BP1.png'),),
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child:Stack(
                    children: [
                      Image(image: AssetImage('image/Min1.png'),height: _mediaquery.size.height*0.4,
                      ),
                      Column(
                        children: [
                          Stack(children: [
