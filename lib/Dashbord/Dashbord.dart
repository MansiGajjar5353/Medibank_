  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Medical Records", style:
        TextStyle(color: Color(0xff000000),
            fontSize: 18, fontWeight: FontWeight.w400, fontFamily: 'Poppins'),),
      ),
      body: SafeArea(
        child: Container(
          child: Column(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton.small(
          ...
          onPressed: () { Navigator.push(context, MaterialPageRoute(builder: (context)=> AddRecords(),)); },
        ),
      ),
    );
