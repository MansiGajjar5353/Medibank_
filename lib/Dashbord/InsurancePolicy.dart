          ...
          children: [
            Align(
              ...
              child: Container(
                ...
                height: Responsive.isSmallScreen(context)? width/3.5 : width/4.5,
                child:  Image.asset("image/insurancecenter.png",height: Responsive.isSmallScreen(context)? width/3.5 : width/4.5,),
              ),
            ),
            Align(
              alignment: Alignment.bottomCenter,
              child: Container(
                margin:EdgeInsets.only(left: Responsive.isSmallScreen(context)? width/10 : width/10,right: Responsive.isSmallScreen(context)? width/10 : width/10,bottom: Responsive.isSmallScreen(context)? width/7 : width/18),

                width: Responsive.isSmallScreen(context)? width/1.5 : width/1.5,
                height: Responsive.isSmallScreen(context)? width/9 : width/18,

                child: ElevatedButton(
                  child: Text('Add New Insurance', style: TextStyle( fontFamily:'Poppins',
                      fontSize:  Responsive.isSmallScreen(context)? width/ 25:width/50, fontWeight: FontWeight.w700,color: Color(0xffFFFFFF)),),
