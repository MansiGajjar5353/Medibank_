                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Image(
                        image: AssetImage("image/blood1.png"),
                        width: Responsive.isSmallScreen(context)
                            ? width / 25
                            : width / 60,
                      ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(padding: EdgeInsets.all(5)),
                      Image(
                        image: AssetImage("image/platelet.png"),
                        width: Responsive.isSmallScreen(context)
                            ? width / 25
                            : width / 60,
                      ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(padding: EdgeInsets.all(5)),
                      Image(
                        image: AssetImage("image/sperm1.png"),
                        width: Responsive.isSmallScreen(context)
                            ? width / 25
                            : width / 60,
                      ),
            ...
            child: Center(
              child: Stack(
                children: [
                  Center(
                    child: Image(
                      image: AssetImage("image/DonatingBlood1.png"),
                      width: Responsive.isSmallScreen(context)
                          ? width / 1.2
                          : width / 1.5,
                    ),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => DetailsAboutFoundation(),
                              ));
                        },
                        child: Container(
                          height: 98,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(
                                child: Image(
                                  image: AssetImage("image/Group52.png"),
                                  width: 40,
                                ),
                              ),
                            ],
            ...
            child: Center(
              child: Stack(
                children: [
                  Center(
                    child: Image(
                      image: AssetImage("image/Bdonation2.png"),
                      width: Responsive.isSmallScreen(context)
                          ? width / 1.2
                          : width / 1.5,
                    ),
