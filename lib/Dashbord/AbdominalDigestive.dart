  ...
  void handleButtonPress() {
    ...
    Future.delayed(const Duration(milliseconds: 200), () {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => RespiratoryLungsProblem(),
          ));
    ...
    return Scaffold(
      ...
      body: ListView(children: [
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Container(
                      child: Image.asset('image/diarrhea.png',
        ...
        Container(
          margin: EdgeInsets.only(left: 20, top: 20, right: 20),
          child: Text(
            "Do you have bloating, gas or indigestion?",
            style: TextStyle(
              color: Color(0xff4F555A).withOpacity(0.45),
              fontSize:
                  Responsive.isSmallScreen(context) ? width / 28 : width / 50,
        ...
        Container(
          margin: EdgeInsets.only(left: 20, top: 20, right: 20),
          child: Text(
            "Do you have change in bowl habits/ stools frequency?",
            style: TextStyle(
              color: Color(0xff4F555A).withOpacity(0.45),
              fontSize:
                  Responsive.isSmallScreen(context) ? width / 28 : width / 50,
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                primary: selectedButton == ButtonState.Button1
                    ? Colors.white
                    : Color(0xffF7F7F7),
                elevation: 0,
                side: BorderSide(
              ...
              child: Container(
                height:
                    Responsive.isSmallScreen(context) ? width / 10 : width / 20,
                ...
                child: Row(
                  ...
                  children: [
                    Image(
                      image: AssetImage("image/SadImage.png"),
                      height: Responsive.isSmallScreen(context)
                          ? width / 20
                          : width / 40,
                    ),
            ...
            child: ElevatedButton(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Image(
                      image: AssetImage("image/Noimage.png"),
                      height: Responsive.isSmallScreen(context)
                          ? width / 20
                          : width / 40,
                    ),
            ...
            child: ElevatedButton(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Image(
                      image: AssetImage("image/SomeImage.png"),
                      height: Responsive.isSmallScreen(context)
                          ? width / 20
                          : width / 40,
                    ),
