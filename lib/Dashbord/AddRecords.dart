  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Add Records", style: TextStyle(color: Color(0xff000000),fontSize: 18, fontWeight: FontWeight.w400, fontFamily: 'Poppins'),),
                  ...
                  Column(
                    children: [
                          ...
                          child: Center(
                            child: Column(mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                ...
                                Text("Lab Report", style: TextStyle(
                      ...
                      InkWell(
                            ...
                            child: Column(mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Container(
                                    height:Responsive.isSmallScreen(context)? 50 : 60,
                                    width:Responsive.isSmallScreen(context)? 50 : 60,
                                    child: Image(image: AssetImage("image/Hospitazation.png"),height:Responsive.isSmallScreen(context)? 20 : 30,
                                      width:Responsive.isSmallScreen(context)? 30 : 40,) ),
                        ...
                        onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context)=> Hospilization(), ));
                          },
                  ...
                  Column(
                    children: [
                      InkWell(
                        ...
                        onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=>Prescription(),));},
                      ),
                      Padding(padding: EdgeInsets.only(top: 10)),
                      InkWell(
                        child: Container(
                          ...
                          child: Center(
                            child: Column(mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Container( height:Responsive.isSmallScreen(context)? 50 : 60,
                                    width:Responsive.isSmallScreen(context)? 50 : 60,
                                    child: Image(image: AssetImage("image/Treatments.png"), height:Responsive.isSmallScreen(context)? 20 : 30,
                                      width:Responsive.isSmallScreen(context)? 30 : 40,)),
                        ...
                        onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> Treatments(),));},
                      ),
