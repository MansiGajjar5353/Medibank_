  ...
  void handleButtonPress() {
    ...
    Future.delayed(const Duration(milliseconds: 200), () {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => DermatologySkin(),
          ));
        ...
        children: [
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      Container(
                        child: Image.asset('image/SoreThroat.png',
          ...
          Visibility(
            ...
            child: Container(
              ...
              width:
                  Responsive.isSmallScreen(context) ? width / 1.13 : width / 2,
              height: 50,
              child: TextField(
          ...
          Container(
            ...
            child: Text(
              "Do you suffer with eye or vision problem?",
              style: TextStyle(
                color: Color(0xff4F555A).withOpacity(0.45),
                fontSize:
                    Responsive.isSmallScreen(context) ? width / 28 : width / 50,
          ...
          Container(
            margin: EdgeInsets.only(left: 20, top: 40, right: 20),
            child: Text(
              "Do you have nose congestion or sinus trouble?",
              style: TextStyle(
                color: Color(0xff4F555A).withOpacity(0.45),
                fontSize:
                    Responsive.isSmallScreen(context) ? width / 28 : width / 50,
          ...
          Container(
            margin: EdgeInsets.only(left: 20, top: 40, right: 20),
            child: Text(
              "Do you have ear or hearing problem?",
              style: TextStyle(
                color: Color(0xff4F555A).withOpacity(0.45),
                fontSize:
                    Responsive.isSmallScreen(context) ? width / 28 : width / 50,
          ...
          Container(
            margin: EdgeInsets.only(left: 20, top: 40, right: 20),
            child: Text(
              "Do you have jaw/joint (TMJ) Problems?",
              style: TextStyle(
                color: Color(0xff4F555A).withOpacity(0.45),
                fontSize:
                    Responsive.isSmallScreen(context) ? width / 28 : width / 50,
