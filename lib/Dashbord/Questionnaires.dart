                        ...
                        onTap: () {
                          if (index == 0) {
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => illnessSurgery(),
                                ));
                          } else if (index == 4) {
                            Navigator.push(
                                context,
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => FamilyMedicalHistory(),
                                ));
                          } else if (index == 8) {
                            Navigator.push(
                                context,
                            ...
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      RespiratoryLungsProblem(),
                                ));
                          } else if (index == 12) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Cardiovascular(),
                                ));
                          } else if (index == 13) {
                            Navigator.push(
                                context,
                            ...
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => JointsMuscleProblem(),
                                ));
                          } else if (index == 16) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => Neurological(),
                                ));
                          } else if (index == 17) {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => ForMan(),
                                ));
                          } else if (index == 18) {
                            Navigator.push(
                                context,
