            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 25),
                      child: Text(
                        "Note: All information not saved will be",
                        style: new TextStyle(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Container(
                      child: Image.asset('image/neurology.png',
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        " Temporary loss of vision, speech",
                        style: TextStyle(
                          color: _isSelected[6]
                              ? Color(0xff24B445)
                              : Color(0xff4F555A).withOpacity(0.5),
              ...
              ElevatedButton(
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "Loss of consciousness(Clack-out)",
                        style: TextStyle(
                          color: _isSelected[2]
                              ? Color(0xff24B445)
                              : Color(0xff4F555A).withOpacity(0.5),
