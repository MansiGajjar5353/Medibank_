...
//
         ...
         Container(
           child: Column(
             ...
             children: [
               Container(margin:EdgeInsets.only(left: 30,top: 20),
                 child: Text("Doctor Name", style: TextStyle(color: Color(0xff4F555A).withOpacity(0.4),fontSize: 14,fontWeight: FontWeight.w400, ),),
               ),
               Container(
                 margin:EdgeInsets.only(left: 30,top: 10),
                 child: Row(
...
//
         ...
         Column(crossAxisAlignment: CrossAxisAlignment.start,
           children: [
             Container(margin:EdgeInsets.only(left: 30,top: 20),
               child: Text("Doctor's Email", style: TextStyle(color: Color(0xff4F555A).withOpacity(0.4),fontSize: 14,fontWeight: FontWeight.w400, ),),
             ),
             Container(
...
//
         ...
         Container(
           child: Column(
             ...
             children: [
               Container(margin:EdgeInsets.only(left: 30,top: 20),
                 child: Text("Doctor's Diagnosis", style: TextStyle(color: Color(0xff4F555A).withOpacity(0.4),fontSize: 14,fontWeight: FontWeight.w400, ),),
               ),
               Container(
                 margin: EdgeInsets.only(left:30,right: 30, top:10),
                 width: Responsive.isSmallScreen(context)? width/1.2 : width/2,
...
//
         ...
         Container(
           child: Column(
             ...
             children: [
               Container(margin:EdgeInsets.only(left: 30,top: 20),
                 child: Text("Medicine Name", style: TextStyle(color: Color(0xff4F555A).withOpacity(0.4),fontSize: 14,fontWeight: FontWeight.w400, ),),
               ),
               Container(
                 margin: EdgeInsets.only(left:30,right: 30, top:10),
                 width: Responsive.isSmallScreen(context)? width/1.2 : width/2,
...
//
         ...
         Container(margin:EdgeInsets.only(left: 30,top: 20),
           child: Text("Frequency",
             style: TextStyle(color: Color(0xffACADAC),fontSize: 14,fontWeight: FontWeight.w400, ),),
         ),
         // Container(
         //   // height: 20,
         //   //   width: 200,
       ...
       children: [
         ...
         // width: 50,
          decoration: BoxDecoration(
           ...
           child: Center(child: Text(Frequency[0], style: TextStyle(color: Color(0xff4F555A).withOpacity(0.50)),)),
         ),
         Container(
           height: 30,
           // width: 50,
           ...
           padding: EdgeInsets.only(left:3, right: 3),
           child: Center(child: Text(Frequency[1],style: TextStyle(color: Color(0xff4F555A).withOpacity(0.50)),)),
         ),
         Container(
           height: 30,
           // width: 50,
           ...
           padding: EdgeInsets.only(left:3, right: 3),
           child: Center(child: Text(Frequency[2],style: TextStyle(color: Color(0xff4F555A).withOpacity(0.50)),)),
         ),
       ],
     ),
     ...
     Row(
       ...
       children: [
         Container(
           ...
           padding: EdgeInsets.only(left:3, right: 3),
           child: Center(child: Text(Frequency[3], style: TextStyle(color: Color(0xff4F555A).withOpacity(0.50)),),),
         ),
         ...
         Container(
           ...
           padding: EdgeInsets.only(left:3, right: 3),
           child: Center(child: Text(Frequency[4],style: TextStyle(color: Color(0xff4F555A).withOpacity(0.50)))),
         ),
         ...
         Container(
           child: Column(
             ...
             children: [
               Container(margin:EdgeInsets.only(left: 30,top: 20),
                 child: Text("No of Days", style: TextStyle(color: Color(0xff4F555A).withOpacity(0.4),fontSize: 14,fontWeight: FontWeight.w400, ),),
               ),
               Container(
                 margin: EdgeInsets.only(left:30,right: 30, top:10),
                 width: Responsive.isSmallScreen(context)? width/1.2 : width/2,
         ...
         Container(
           ...
           child: Row(
             ...
             children: [
               Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    width: Responsive.isSmallScreen(context)? width/1.8: width/3,
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Container(
              ...
              Container(
                child: Center(
                  child: Image(image: AssetImage("image/Cross.png"),height: 40,),
                ),
              ),
             ],
           ),
