    ...
    children: [
      Center(
        child: Container(
          ...
          child: Image(image: AssetImage("image/AbhaDP.png"),),
        ),
        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              ...
              width: Responsive.isSmallScreen(context)? width/22 : width/40,
              child: Image(image: AssetImage("image/GreenAerrow.png",
              ),),
            ),
          ],
        ),
      ...
      Center(
        child: Container(
          //  width: Responsive.isSmallScreen(context)? width/1.35 : width/1.8,
            child: Text("Female, 23 years",
              style: TextStyle(
                color: Color(0xff929292),
                fontSize: Responsive.isSmallScreen(context)? width/33: width/60,
                fontFamily: 'Poppins',
      ...
      Center(
        child: Container(margin: EdgeInsets.all(30),
            child: Image(image: AssetImage("image/QR.png"),)),
      ),
      ...
      Center(
        child: Container(
          ...
          //  width: Responsive.isSmallScreen(context)? width/1.35 : width/1.8,
            child: Text("View your ABHA card",
              style: TextStyle(
      ...
      Column(
        children: [
          Container(width: _mediaquery.size.width*0.6,
