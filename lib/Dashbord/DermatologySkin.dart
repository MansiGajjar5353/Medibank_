  ...
  void handleButtonPress() {
    ...
    Future.delayed(const Duration(milliseconds: 200), () {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => AbdominalDigestive(),
          ));
    });
  }
    ...
    return Scaffold(
      ...
      body: ListView(children: [
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Container(
                      child: Image.asset('image/Skin1.png',
        ...
        Container(
          ...
          child: Text(
            "Do you suffer with headache or migraine?",
            style: TextStyle(
            ...
            children: [
              Container(
                child: Container(
                  ...
                  child: Text(
                    "Have you noticed any change with your",
                    style: TextStyle(
                      color: Color(0xff4F555A).withOpacity(0.45),
                      fontSize: Responsive.isSmallScreen(context)
                          ? width / 28
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary:
                              _isSelected[0] ? Colors.white : Color(0xffF7F7F7),
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary:
                              _isSelected[1] ? Colors.white : Color(0xffF7F7F7),
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary:
                              _isSelected[3] ? Colors.white : Color(0xffF7F7F7),
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary:
                              _isSelected[4] ? Colors.white : Color(0xffF7F7F7),
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary:
                              _isSelected[6] ? Colors.white : Color(0xffF7F7F7),
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary:
                              _isSelected[7] ? Colors.white : Color(0xffF7F7F7),
                          onPrimary: _isSelected[7]
                              ? Color(0xffFFFFFF)
                              : Color(0xff4F555A).withOpacity(0.5),
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(18.0),
