...
return Scaffold(
  ...
  mainAxisAlignment: MainAxisAlignment.spaceBetween,
    ...
    child: Text("Birthplace", style: TextStyle(color: Color(0xff4F555A).withOpacity(0.5),
...
enum ButtonState { Button1, Button2, Button3 , Button4, Button5, Button6, Button7, Button8, Button9}
                  ...
                  children: [
                    Center(
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image(image: AssetImage("image/Maharashtra.png"),height: 70 ),
                          Container(
                            child: Text("Maharashtra", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button1 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                      child:Visibility(
                  ...
                  children: [
                    Center(
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image(image: AssetImage("image/Rajasthan.png"),height: 70 ),
                          Container(
                            child: Text("Rajasthan", style: TextStyle(fontSize: 10,
                                fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button2 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                  ...
                  children: [
                    Center(
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Image(image: AssetImage("image/Gujarat.png"),height: 70 ),
                          Container(
                            child: Text("Gujarat", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button3 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          Image(image: AssetImage("image/Maharashtra.png"),height: 70 ),
                          Container(
                            child: Text("Gujarat", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button4 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                      child:Visibility(
                        visible: selectedButton== ButtonState.Button4 ? true : false,
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                            shape: BoxShape.circle,
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          Image(image: AssetImage("image/Maharashtra.png"),height: 70 ),
                          Container(
                            child: Text("Gujarat", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button5 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                      child:Visibility(
                        visible: selectedButton== ButtonState.Button5 ? true : false,
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                            shape: BoxShape.circle,
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          Image(image: AssetImage("image/Maharashtra.png"),height: 70 ),
                          Container(
                            child: Text("Gujarat", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button6 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                      child:Visibility(
                        visible: selectedButton== ButtonState.Button6 ? true : false,
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                            shape: BoxShape.circle,
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          Image(image: AssetImage("image/Maharashtra.png"),height: 70 ),
                          Container(
                            child: Text("Gujarat", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button7 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                      child:Visibility(
                        visible: selectedButton== ButtonState.Button7 ? true : false,
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                            shape: BoxShape.circle,
                    ...
                    Center(
                      child: Column(
                        ...
                        children: [
                          Image(image: AssetImage("image/Maharashtra.png"),height: 70 ),
                          Container(
                            child: Text("Gujarat", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState.Button8 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                        ],
                      ),
                    ),
                    Transform.translate(offset: Offset(85,2),
                      child:Visibility(
                        visible: selectedButton== ButtonState.Button8 ? true : false,
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                            shape: BoxShape.circle,
                ...
                children: [
                  Center(
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Image(image: AssetImage("image/Employed.png"),height: 70 ),
                        Container(
                          child: Text("Employed", style: TextStyle(fontSize: 10,
                              fontWeight: FontWeight.w500,color: selectedButton==ButtonState2.Button1 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                      ],
                    ),
                  ),
                  Transform.translate(offset: Offset(85,2),
                    child:Visibility(
                      visible: selectedButton== ButtonState2.Button1 ? true : false,
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.white,
                          shape: BoxShape.circle,
                ...
                children: [
                  Center(
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Image(image: AssetImage("image/Retired.png"),height: 60 ),
                        Container(
                          child: Text("Retired", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w500,color: selectedButton==ButtonState2.Button2 ?Color(0xff24B445):Color(0xff4F555A).withOpacity(0.50)),),),
                      ],
                    ),
                  ),
                  Transform.translate(offset: Offset(85,2),
                    child:Visibility(
                      visible: selectedButton== ButtonState2.Button2 ? true : false,
                      child: Container(
                        decoration: BoxDecoration(
                          color: Colors.white,
                          shape: BoxShape.circle,
