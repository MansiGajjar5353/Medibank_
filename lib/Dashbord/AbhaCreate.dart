            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Center(
                    child: Container(
                       child: Text("TheMedibank does not store any data.",
                        style: TextStyle(color: Color(0xffFFFFFF),
                            fontFamily: "Poppins",
                            fontWeight: FontWeight.w600,
                            fontSize: Responsive.isSmallScreen(context)? width/35 : width/65),
                      ),
                    ),
                  ),
              ...
              child:Stack(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      color:selectedButton== ButtonState2.Button1 ? Color(0xffADE3BA):Color(0xffFFFFFF),
                      border: Border.all(color: selectedButton== ButtonState2.Button1? Colors.transparent : Color(0xffBEBEBE))
                    ),
                    child:Row(
                      children: [
                        Container(
                            margin:EdgeInsets.all(10),
                    child: Image(image:AssetImage("image/Phone.png"), height: 35,)),
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Container(
                                child: Text("Mobile ", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),)),
                            Container(width: _mediaquery.size.width*0.5,
                                child: Text(softWrap: true,"Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.",
                                  style: TextStyle(fontSize: 8, color: Color(0xff7D7D7D), fontWeight: FontWeight.w400),)),
                          ],
                        ),
                      ],
                    )
                  ...
                  Transform.translate(offset: Offset(220,2),
                    child:Visibility(
              ...
              child:Stack(
                children: [
                  Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          color:selectedButton== ButtonState2.Button2 ? Color(0xffADE3BA):Color(0xffFFFFFF),
                          border: Border.all(color: selectedButton== ButtonState2.Button1? Colors.transparent : Color(0xffBEBEBE))
                      ),
                      child:Row(
                        children: [
                          Container(
                              margin:EdgeInsets.all(10),
                              child: Image(image:AssetImage("image/Adhar.png"), height: 35,)),
                          Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Container(
                                  child: Text("Aadhar ", style: TextStyle(fontSize: 15, fontWeight: FontWeight.w500),)),
                              Container(width: _mediaquery.size.width*0.5,
                                  child: Text(softWrap: true,"Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.",
                                    style: TextStyle(fontSize: 8, color: Color(0xff7D7D7D), fontWeight: FontWeight.w400),)),
                            ],
