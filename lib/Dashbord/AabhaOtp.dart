...
import 'package:project_signup_page/Dashbord/AabhaAdd.dart';
import '../Onbording/Responsive.dart';
import '../UI/Email.dart';

class AabhaOtp extends StatefulWidget {
  //final String data;
  //const otpScreen(this.data,{ super.key})

  @override
  State<StatefulWidget> createState() {
    return _AabhaOtpState();
  }
}

class _AabhaOtpState extends State<AabhaOtp> {
